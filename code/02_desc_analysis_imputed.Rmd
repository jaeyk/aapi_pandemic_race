...
covat2 <- factorize(covat2)
covat3 <- factorize(covat3)

mods_exo <- list(

  "2nd wave" = lm(gendiscrim ~ apa.discrim.rona + usborn + edu + DEM + GOP + age + male + chinese + indian, data = covat2),
  
  "3rd wave" = lm(gendiscrim ~ apa.discrim.rona + usborn + edu + DEM + GOP + age + male + chinese + indian, data = covat3)
...
sub.models <- list(
    ...
    "High Discrimination Pre-COVID" = lm(likely_vote ~ gendiscrim + apa.discrim.rona + usborn + edu + DEM + GOP + age + male + wave + chinese + indian, data = subset(df, prior == "High")),
            
    "Middle Discrimination Pre-COVID" = lm(likely_vote ~ gendiscrim + apa.discrim.rona + usborn + edu + DEM + GOP + age + male + wave + chinese + indian, data = subset(df, prior == "Middle")),
            
    "Low Discrimination Pre-COVID" = lm(likely_vote ~ gendiscrim + apa.discrim.rona + usborn + edu + DEM + GOP + age + male + wave + chinese + indian, data = subset(df, prior == "Low"))
    )
...
```{r}
model <- lm(biden ~ gendiscrim + apa.discrim.rona + usborn + edu + DEM + GOP + age + male + wave + chinese + indian, data = subset(df, prior == "Low"))
