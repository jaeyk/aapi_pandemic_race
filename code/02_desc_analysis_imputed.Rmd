...
ggsave(here("outputs", "vote2020_imputed.png"), width = 10, 
       height = 10)
```
...
ggsave(here("outputs", "vote2020_sub_imputed.png"), width = 10, 
       height = 10)
```
...
ggsave(here("outputs", "biden_imputed.png"), width = 8, height = 8)
```
