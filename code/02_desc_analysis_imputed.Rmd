...
models <- list(
  ...
  "Interaction term" = lm(likely_vote ~ apa.discrim.rona + gendiscrim + prior + apa.discrim.rona:prior + usborn + edu + DEM + GOP + age + male + wave + nat_origin, data = df)
)
```
...
```{r}
sense.out <- sensemakr(
  model = lm(likely_vote ~ apa.discrim.rona + gendiscrim + usborn + edu + DEM + GOP + age + male + wave + nat_origin, data = df),
...
sense.out.biden <- sensemakr(
  model = lm(biden ~ apa.discrim.rona + gendiscrim + usborn + edu + DEM + GOP + age + male + wave + nat_origin, data = df),
  treatment = "apa.discrim.rona",
